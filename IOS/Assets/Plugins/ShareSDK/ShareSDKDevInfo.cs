...
//		#endif
	...
	public class SinaWeiboDevInfo : DevInfo 
	{
		...
		public string AppKey = "3456727435";
		public string AppSecret = "d114468818a80eef31892a0760124be1";
		public string RedirectUrl = "https://api.shaojishiduo.com/ThirdPlugin/sina_weibo_notify";
		public bool ShareByAppClient = false;
		#elif UNITY_IPHONE
		public const int type = (int) PlatformType.SinaWeibo;
		public string app_key = "3456727435";
		public string app_secret = "d114468818a80eef31892a0760124be1";
		public string redirect_uri = "https://api.shaojishiduo.com/ThirdPlugin/sina_weibo_notify";
	...
	public class QQ : DevInfo 
	{
		...
		public string SortId = "3";
		public string AppId = "1106021812";
		public string AppKey = "ZxWcDTBb90cfTyDr";
		public bool ShareByAppClient = true;
		#elif UNITY_IPHONE
		public const int type = (int) PlatformType.QQ;
		public string app_id = "1106021812";
		public string app_key = "ZxWcDTBb90cfTyDr";
		public string auth_type = "both";  //can pass "both","sso",or "web" 
		#endif
	}
	...
	{	
		...
		public string AppId = "wxe959e86bfda2583c";
		public string AppSecret = "62093411771f00c82e2a0b6aaf970ca6";
		public bool BypassApproval = false;
		#elif UNITY_IPHONE
		public const int type = (int) PlatformType.WeChat;
		public string app_id = "wxe959e86bfda2583c";
		public string app_secret = "62093411771f00c82e2a0b6aaf970ca6";
		#endif
	}
	...
	public class Facebook : DevInfo 
	{
		...
		public string ConsumerKey = "732683093575228";
		public string ConsumerSecret = "ea0325352875f3ea1995ce2eb5817749";
		public string RedirectUrl = "https://api.shaojishiduo.com/ThirdPlugin/facebook_notify";
		#elif UNITY_IPHONE
		public const int type = (int) PlatformType.Facebook;
		public string api_key = "732683093575228";
		public string app_secret = "ea0325352875f3ea1995ce2eb5817749";
		public string auth_type = "both";  //can pass "both","sso",or "web" 
		public string display_name = "Scream Bird";//如果需要使用客户端分享，必填且需与FB 后台配置一样
		#endif
	}
	...
	public class Twitter : DevInfo 
	{
		...
		public string ConsumerKey = "XId3NFijHo40WQnwis8UDdFVd";
		public string ConsumerSecret = "WHB6IbVt7yTIZAte2LuzJeedTPJbEU6RHe1CQcotstJ3Zzu1oC";
		public string CallbackUrl = "https://api.shaojishiduo.com/ThirdPlugin/twitter_notify";
		#elif UNITY_IPHONE
		public const int type = (int) PlatformType.Twitter;
		public string consumer_key = "XId3NFijHo40WQnwis8UDdFVd";
		public string consumer_secret = "WHB6IbVt7yTIZAte2LuzJeedTPJbEU6RHe1CQcotstJ3Zzu1oC";
		public string redirect_uri = "https://api.shaojishiduo.com/ThirdPlugin/twitter_notify";
		#endif
	}
	...
	public class Instagram : DevInfo 
	{
		...
		public string ClientId = "be77c3f627ac4dfdb1413003b11ea7d9";
		public string ClientSecret = "6b54134ce3b944a3859d7f7ec52e830f";
		public string RedirectUri = "https://api.shaojishiduo.com/ThirdPlugin/instagram_notify";
		#elif UNITY_IPHONE
		public const int type = (int) PlatformType.Instagram;
		public string client_id = "be77c3f627ac4dfdb1413003b11ea7d9";
		public string client_secret = "6b54134ce3b944a3859d7f7ec52e830f";
		public string redirect_uri = "https://api.shaojishiduo.com/ThirdPlugin/instagram_notify";
		#endif
	}
